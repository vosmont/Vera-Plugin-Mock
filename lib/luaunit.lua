...
function assertFalse (actual, msg)
	assertEquals(actual, false, msg)
end
assert_false = assertFalse

function assertTrue (actual, msg)
	assertEquals(actual, true, msg)
end
...
UnitResult = { -- class
	...
	currentExpectedAssertionCount = -1,
...
local LuaUnit = {
	...
	function LuaUnit:runTestMethod(aName, aClassInstance, aMethod)
		...
		-- run testMethod()
		self.result.currentAssertionCount = 0
		self.result.currentExpectedAssertionCount = -1
